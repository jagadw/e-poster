    ...
    @section('content')
        ...
        <div class="pb-4">
            <a href="{{ route('login') }}" class="px-3 py-2 bg-[#36ab40] text-white rounded">Login {{ '(Admin)' }}</a>
        </div>
                    ...
                    @foreach ($Posters as $poster)
                        <tr>
                            ...
                            <td class="border px-2 py-1 text-center">
                                <a href="{{ route('ViewPoster', $poster) }}" class="bg-[#36ab40] text-white px-2 py-1 rounded">View</a>
                            </td>
                        </tr>
                    @endforeach
                </tbody>
