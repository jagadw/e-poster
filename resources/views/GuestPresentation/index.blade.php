...
<div id="table-wrapper">
    <div class="py-4 px-6">
        ...
        <div class="py-4">
            <a href="{{ route('/') }}" class="px-3 py-2 bg-gray-600 text-white rounded">Back</a>
        </div>

        <form id="formSearch" method="GET" action="{{ route('GuestPresentation') }}"
            ...
            <button type="submit" class="bg-green-600 text-white px-4 py-2 rounded">GO</button>
            <a href="{{ route('GuestPresentation') }}" class="bg-gray-300 text-black px-4 py-2 rounded">Reset</a>
        </form>
