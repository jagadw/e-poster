          ...
          <table class="table w-full mt-4 border overflow-x-auto">
              ...
              <tbody>
                  ...
                  <tr>
                      ...
                      <td>
                          <a href="{{ route('presentations.edit', $p->id) }}" class="bg-[#36ab40] text-white px-2 py-1 rounded">Edit</a>
                          <form action="{{ route('presentations.destroy', $p->id) }}" method="POST" style="display:inline;">
                              @csrf @method('DELETE')
